...
function printUsageAndExit() {
	...
	echo "Example: $VAR_MYNAME arm64" >/dev/stderr
	exit 1
}
...
LVAR_QEMU_TRG_ARCH=""
LVAR_DEB_TRG_RFS=""
LVAR_CPUARCH_DARTSDK_TRG=""
case "$OPT_DEBIAN_TRG_DIST" in
	arm64)
		LVAR_QEMU_TRG_ARCH="aarch64"
		LVAR_DEB_TRG_RFS="arm64v8"
		LVAR_CPUARCH_DARTSDK_TRG="arm64"
		;;
	armhf)
		LVAR_QEMU_TRG_ARCH="arm"
		LVAR_DEB_TRG_RFS="arm32v7"
		LVAR_CPUARCH_DARTSDK_TRG="arm"
		;;
	*)
...
LVAR_IMAGE_NAME="dartsass-${OPT_DEBIAN_TRG_DIST}-builder-cross-${LVAR_DEBIAN_DIST}"
